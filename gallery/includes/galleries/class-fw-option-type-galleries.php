...
class FW_Option_Type_Galleries extends FW_Option_Type
{
	private $extension_name = 'gallery';
...
FW_Option_Type::register('FW_Option_Type_Galleries');

add_action('wp_ajax_cache_slide', array('FW_Option_Type_Galleries', '_action_ajax_cache_slide'));
add_action('wp_ajax_resize_slide', array('FW_Option_Type_Galleries', '_action_ajax_resize_slide'));